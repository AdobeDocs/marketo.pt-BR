...
Para copiar o nome de um token para a área de transferência (isto é, {{my.Evento Calendar File}}), clique com o botão direito do mouse no token e selecione [!UICONTROL **Copiar nome**] do token.
