---
title: definição-a-smart-lista-para-uma-campanha em lote
...
1. Clique na lista suspensa e escolha um operador de filtro (por exemplo, [!UICONTROL **é**], não [!UICONTROL ****]&#x200B;é etc.) para o filtro escolhido.
