...
Verifique se você está configurado corretamente com os tipos certos de acesso e informações. Execute estas etapas simples para que você possa retirar algumas coisas da sua lista de tarefas imediatamente!
...
* Saiba como se envolver com o [**Nação de marketing**](https://nation.marketo.com/t5/About-Community/ct-p/about-community){target="_blank"} para obter respostas para suas perguntas.
