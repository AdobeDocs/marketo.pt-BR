...
<li>Todos os programas <a href="/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md" target="_blank">estão sincronizados com Campanhas SFDC</a> (se aplicável)?</li>
...
<li>Como os seus formulários globais apontam os usuários para uma <a href="/help/marketo/product-docs/demand-generation/forms/creating-a-form/set-a-form-thank-you-page.md" target="_blank">página de agradecimento</a> (via campo de formulário oculto ou no modelo de página do seu CMS)?</li>
