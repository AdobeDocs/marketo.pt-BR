...
* **Adicionar o Marketo incluir na lista de permissões à sua pesquisa de e-mail corporativa**. É uma prática recomendada enviar emails de teste para suas contas de teste antes de enviar emails para pessoas reais. Incluir na lista de permissões Com o ➡ Marketo, você pode impedir que esses emails de teste sejam bloqueados ou sinalizados como spam.
* **Configurar SPF e DKIM**. Essas tecnologias garantem aos recipients que os emails do Marketo não são spam. Para ajudar a impedir que os filtros de spam dos recipients rejeitem seus emails do Marketo, siga estas etapas para [Configurar um SPF e um DKIM para a capacidade de entrega de emails](/help/marketo/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md).
...
Para recuperar a ID do Munchkin que você substituirá pela sua página de aterrissagem CNAME, acesse o **Admin** área.
...
Envie o e-mail para TI. Sabemos que pode levar algum tempo para que a TI conclua essas tarefas. Você pode continuar com a próxima etapa, mas lembre-se de retornar a esta etapa para concluir a configuração do Marketo Engage.
