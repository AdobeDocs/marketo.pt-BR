...
>[!NOTE]
>
>Você também pode baixar essa lista de verificação, [junto com uma lista de práticas recomendadas](/help/marketo/getting-started/inheriting-a-marketo-engage-instance/assets/adobe-marketo-engage-new-instance-admin-checklist.xlsx) para a nova instância e confira as etapas conforme avança.
