...
* [Lista de Verificação da Instalação do Usuário](/help/marketo/getting-started/initial-setup/user-setup.md){target="_blank"}
...
* [Documentar a configuração da nova instância](/help/marketo/getting-started/implementing-a-new-marketo-engage-instance/document-your-setup.md){target="_blank"}
