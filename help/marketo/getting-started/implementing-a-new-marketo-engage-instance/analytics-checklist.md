...
<tbody>
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/pt-br/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">Use um período relevante</a> (por exemplo, até a presente data, últimos 90 dias etc.) para que o relatório forneça uma exibição precisa das métricas padrão de envolvimento e capacidade de entrega de emails.</li>
...
Alguns relatórios do Marketo Engage são mais bem implantados como ativos locais em programas específicos em Atividades de marketing, pois seu uso típico é em um conjunto mais limitado de programas e ativos. Considere a configuração de relatórios básicos, como:
