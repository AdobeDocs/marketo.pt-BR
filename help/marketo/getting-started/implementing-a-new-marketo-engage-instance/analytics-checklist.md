...
# Novas práticas recomendadas da instância: lista de verificação do Analytics {#new-instance-best-practices-analytics-checklist}
...
<tbody>
  ...
  <tr>
    <td>Relatório de desempenho da página de destino</td>
  ...
  <tr>
    <td>Relatório de atividades de página da web</td>
...
<tbody>
  <tr>
    <td>Relatório de desempenho de link de email</td>
