...
description: Saiba mais sobre a Pontuação de conta e como ela ajuda a priorizar contas de destino engajadas. Configure as pontuações da conta atribuindo pontuações de lead no Administrador do TAM.
