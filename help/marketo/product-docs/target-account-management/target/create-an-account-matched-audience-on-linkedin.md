...
1. No TAM, clique no link **Listas de contas** guia.
...
1. Clique em **Ações da lista de contas** e selecione **Enviar via AdBridge**.

   ![](assets/create-a-matched-audience-on-linkedin-3.png)

1. Escolher **LinkedIn** e clique em **Próxima**.

   ![](assets/create-a-matched-audience-on-linkedin-4.png)

1. Clique em **Público** menu suspenso. Você pode selecionar um público existente ou criar um novo. Neste exemplo, criaremos um novo (se você selecionar um público existente, pule para a Etapa 7).

   ![](assets/create-a-matched-audience-on-linkedin-5.png)

1. Clique em **Conta de publicidade** e selecione a conta de anúncio de destino.

   ![](assets/create-a-matched-audience-on-linkedin-6.png)

1. Nomeie o público-alvo e clique em **Atualizar**.
