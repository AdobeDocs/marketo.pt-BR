---
description: Saiba mais sobre os termos da atividade de vendas do Sales Connect. Use este glossário para tipos de atividades que se sincronizam com o Marketo e o Salesforce.
...
As atividades abaixo serão registradas no Marketo a partir de [!DNL Sales Connect].
...
<table>
 ...
 <tr>
  <td>Nome do [!UICONTROL Modelo de Vendas]</td>
 </tr>
 <tr>
 ...
 <tr>
  <th rowspan="9"> Abrir email de vendas</th>
  <td>[!UICONTROL Enviado Por]</td>
 </tr>
 <tr>
  <td>Origem</td>
