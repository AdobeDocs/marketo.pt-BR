...
description: Saiba como configurar o SSO por meio do SAML 2.0 no Sales Connect. Obtenha os requisitos e as etapas de configuração para seu provedor de SSO e domínio exclusivo.
