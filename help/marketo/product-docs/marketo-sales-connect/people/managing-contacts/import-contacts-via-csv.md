...
description: Saiba como importar contatos via CSV para o Sales Connect. Faça upload de um arquivo CSV para adicionar vários contatos ou grupos de uma só vez.
