...
description: Saiba como configurar um canal de entrega personalizado no Sales Connect. Use seu próprio SMTP ou infraestrutura de envio para emails de vendas.
