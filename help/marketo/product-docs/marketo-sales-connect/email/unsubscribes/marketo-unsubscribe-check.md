...
description: Entenda a verificação de cancelamento de inscrição do Marketo no Sales Connect. Saiba como o Sales Connect respeita o status de cancelamento de inscrição da Marketo ao enviar.
