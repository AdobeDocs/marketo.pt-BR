...
description: Obtenha ajuda quando a atividade Sales Connect não efetuar logon no Salesforce. Solucione por que os emails, chamadas ou tarefas não estão sendo sincronizados.
title: Não registrado no Salesforce
