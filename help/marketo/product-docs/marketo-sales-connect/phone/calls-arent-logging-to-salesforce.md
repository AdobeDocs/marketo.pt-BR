...
description: Obtenha ajuda quando as chamadas do Sales Connect não estiverem fazendo logon no Salesforce. Solução de problemas de configurações de conexão e registro de atividades.
