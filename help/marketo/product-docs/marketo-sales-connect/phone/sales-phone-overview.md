...
description: Saiba mais sobre Telefone de Vendas em Sales Connect. Fazer chamadas do aplicativo, fazer logon no Salesforce e usar a gravação de chamadas e a presença local.
