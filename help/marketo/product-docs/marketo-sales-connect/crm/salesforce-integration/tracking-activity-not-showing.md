...
description: Obtenha ajuda quando a atividade de rastreamento do Sales Connect não for exibida no Salesforce. Solucione problemas que impedem que emails ou chamadas sejam registrados no Salesforce.
title: A atividade de rastreamento não é exibida
...
# A atividade de rastreamento não é exibida {#tracking-activity-not-showing}
