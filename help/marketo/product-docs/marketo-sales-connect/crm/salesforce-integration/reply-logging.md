...
description: Entenda como o registro de respostas funciona quando o Sales Connect está conectado ao Salesforce. Obtenha ajuda para configurar onde as respostas são conectadas no Salesforce.
