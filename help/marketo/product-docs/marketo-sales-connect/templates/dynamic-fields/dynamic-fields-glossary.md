...
description: Saiba mais sobre campos dinâmicos em Sales Connect. Use este glossário para encontrar campos de mesclagem disponíveis para modelos e personalização.
