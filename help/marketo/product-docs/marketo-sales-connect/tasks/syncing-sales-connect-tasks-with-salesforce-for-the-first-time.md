...
description: Saiba como sincronizar tarefas do Sales Connect com o Salesforce pela primeira vez. Configure a sincronização de tarefas para que as tarefas apareçam no Salesforce.
