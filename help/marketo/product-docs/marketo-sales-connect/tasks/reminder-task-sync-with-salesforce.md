---
description: Entenda como as tarefas de lembrete do Sales Connect são sincronizadas com o Salesforce. Saiba mais sobre o comportamento de sincronização e onde as tarefas aparecem no Salesforce.
