...
1. No Marketo, Clique Em **[!UICONTROL Admin]**. Selecionar **[!UICONTROL CRM]** e clique em **[!UICONTROL Sincronizar com Veeva]**.
...
1. Clique em **[!UICONTROL Iniciar Sincronização Veeva]** para iniciar a sincronização persistente do Marketo-Veeva CRM.
...
1. No Marketo, clique em **[!UICONTROL Admin]**, depois **[!UICONTROL Veeva]**.
