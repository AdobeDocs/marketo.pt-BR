---
description: Saiba como criar um usuário do Veeva CRM para sincronização com o Marketo Engage. Defina layouts de página, crie o usuário de sincronização e atribua permissões para atualizações de campo.
...
Agora você tem uma conta que a Marketo Engage pode usar para se conectar ao CRM [!DNL Veeva].
