...
1. Em Gerenciamento de Banco de Dados, clique na guia **[!UICONTROL Sincronização de Entidades do Dynamics]** link.

   ![](assets/enable-sync-for-a-custom-entity-3.png)

1. Clique em **[!UICONTROL Sincronizar esquema]** link.
