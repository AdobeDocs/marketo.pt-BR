...
A sincronização do Marketo com o Dynamics é superpoderosa. Veja os detalhes:
...
>[!NOTE]
>
>As exclusões nem sempre são sincronizadas em ambas as direções automaticamente. Consulte [Excluindo um Cliente Potencial ou Contato](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/deleting-a-lead-or-contact.md).
...
Sim, use o [Sincronizar pessoa com o Microsoft](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md) ação de fluxo. Isso criará um cliente potencial no Dynamics se o cliente potencial não existir. Se o lead existir, a etapa de fluxo não executará nenhuma ação.
...
Você pode [selecionar campos para sincronização](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-4-of-4-connect.md#select-fields-to-sync) durante a configuração.
