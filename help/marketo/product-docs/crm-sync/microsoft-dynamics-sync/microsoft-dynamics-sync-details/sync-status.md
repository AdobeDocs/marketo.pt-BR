...
description: Saiba mais sobre o status de sincronização do Microsoft Dynamics e como monitorar a taxa de transferência e o backlog. Exiba as guias Status da sincronização e Erros de sincronização em Admin.
...
1. Clique no menu suspenso **[!UICONTROL Exibir]** e selecione **[!UICONTROL Última Hora]** para exibir as informações de taxa de transferência.
   ...
   >[!NOTE]
   >
   >Quando você está olhando para a exibição [!UICONTROL Última Hora], as colunas [!UICONTROL Inserções] e [!UICONTROL Atualizações] exibem N/D. Esse é o comportamento esperado.
