...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><p>Correção de erros: Para ocultar a senha secreta MSI na configuração da API MSD</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">26/05/20</td> 
   <td colspan="1">2.0.0.18</td> 
   <td colspan="1"><p>Correção de erros: Alteração da validação da ID da função MSI para exibir botões MSI</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">21/05/20</td> 
   <td colspan="1">2.0.0.17</td> 
   <td colspan="1"><p>Correção de erros: Mostrar campo proprietário e tornar os campos não obrigatórios</p></td> 
  </tr> 
  <tr> 
