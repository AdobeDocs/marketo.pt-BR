...
1. Faça logon no Marketo e clique em **Aadmin**.
...
1. Insira o **[!UICONTROL Nome de usuário]**, **[!UICONTROL Senha]**, Microsoft Dynamics **URL**, **[!UICONTROL ID do cliente]**, e **[!UICONTROL Segredo do cliente]**. Clique em **[!UICONTROL Salvar]** quando terminar.
