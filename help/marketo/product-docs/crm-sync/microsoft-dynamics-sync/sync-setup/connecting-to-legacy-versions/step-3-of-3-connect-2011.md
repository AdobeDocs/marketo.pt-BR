...
# Etapa 3 de 3: Conectar o Microsoft Dynamics ao Marketo (2011 no local) {#step-of-connect-microsoft-dynamics-with-marketo-on-premises}
...
1. Insira o **Nome do usuário**, **Senha** e CRM **URL** em seguida, clique em **Salvar**.
...
1. Clique em **Editar** em **Etapa 2: Selecione Campos a serem sincronizados.**
