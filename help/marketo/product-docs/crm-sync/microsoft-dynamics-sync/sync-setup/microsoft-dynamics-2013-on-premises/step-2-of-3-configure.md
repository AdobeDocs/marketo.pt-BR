...
1. Em **Configurações**, clique em **Configuração do Marketing**.
   ...
   >[!NOTE]
   >
   >Se **Configuração do Marketing** estiver ausente, tente atualizar a página. Se o problema persistir, [publique a solução Marketo](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-1-of-3-install.md) novamente ou tente fazer logoff e login novamente.
...
>[!MORELIKETHIS]
>
>[Etapa 3 de 3: Connect Marketing e Dynamics (2013 no local)](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-3-of-3-connect.md)
