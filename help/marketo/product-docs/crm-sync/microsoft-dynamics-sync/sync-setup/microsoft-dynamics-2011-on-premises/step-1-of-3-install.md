...
1. Faça logon em **Dynamics**, selecione **Settings** no menu inferior esquerdo.

   ![](assets/image2015-4-2-11-3a32-3a53.png)

1. Selecione **Solutions** na árvore.
...
1. Clique em **Procurar**. Selecione a solução de Gerenciamento de lead da Marketo [baixada](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Clique em **Next**.
...
1. Verifique se a caixa de seleção da opção SDK message está marcada. Clique em **Next**.
