...
# Etapa 1 de 3: Instalar a solução Marketing (Online) {#step-of-install-the-marketo-solution-online}
...
1. Efetue login no ** [Microsoft Office 365](https://login.microsoftonline.com/) **.

   ![](assets/image2015-3-16-15-3a58-3a55.png)

1. Clique no ![](assets/image2015-3-16-16-3a1-3a13.png)menu e selecione **CRM**.

   ![](assets/image2015-3-16-16-3a0-3a10.png)

1. Clique no ![](assets/image2015-5-13-10-3a5-3a8.png) menu. No menu suspenso, selecione **Configurações **e, em seguida, selecione **Soluções**.
...
1. Clique em **Escolher arquivo.** Selecione a solução de Gerenciamento líder de mercado que você [baixou](../../../../../product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Clique em **Avançar**.
...
1. Agora, na página Informações da solução, clique em **Avançar**.
