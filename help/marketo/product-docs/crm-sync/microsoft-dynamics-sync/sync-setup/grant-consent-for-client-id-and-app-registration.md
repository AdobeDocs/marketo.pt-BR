...
>[!MORELIKETHIS]
>
>[Configurar o aplicativo Microsoft Dynamics CRM no local](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/set-up-microsoft-dynamics-crm-app-for-on-prem.md)
