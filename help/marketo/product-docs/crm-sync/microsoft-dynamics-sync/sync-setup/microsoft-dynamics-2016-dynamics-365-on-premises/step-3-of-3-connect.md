---
description: Saiba como conectar o Marketo ao Dynamics 2016 ou Dynamics 365 no local na etapa 3. Insira as credenciais do usuário de sincronização no Marketo Admin e habilite a sincronização.
...
1. Insira o **Nome de Usuário**, **Senha**, [!DNL Microsoft Dynamics] **URL** e um **Segredo/ID do Cliente**. Clique em **Salvar** quando terminar.
   ...
   >[!NOTE]
   >
   >* Se seu Marketo foi provisionado antes de outubro de 2020, ID do cliente e Segredo são campos opcionais. Caso contrário, elas são obrigatórias. A obtenção dessas informações dependerá da versão do MSD que você está usando.
