---
description: Saiba como configurar o usuário de sincronização do Marketo para o Dynamics 2016 ou Dynamics 365 no local. Crie o usuário e atribua a função Usuário de sincronização do Marketo no Dynamics.
