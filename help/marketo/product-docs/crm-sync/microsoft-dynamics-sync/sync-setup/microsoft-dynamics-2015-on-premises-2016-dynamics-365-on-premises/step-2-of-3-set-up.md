...
description: Instale o Marketo para Dynamics 2015 no local e 2016 365 no local etapa 2 de 3 - Documentos do Marketo - Documentação do produto
...
>[!NOTE]
>
>Isso se aplica à versão 4.0.0.14 e posterior do Marketo. Para versões anteriores, todos os usuários devem ter a função de sincronização do usuário. Para atualizar seu Marketo, consulte [Atualizar a solução Marketo para Microsoft Dynamics](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/update-the-marketo-solution-for-microsoft-dynamics.md).
...
1. Você verá uma lista de usuários aqui. Selecione o usuário dedicado da Sincronização do Marketo ou entre em contato com o administrador do [Ative Diretory Federation Services](https://msdn.microsoft.com/en-us/library/bb897402.aspx)(ADFS) para criar um usuário dedicado para o Marketo.
...
1. Selecione o usuário de sincronização. Clique em **Gerenciar funções**.
   ...
   Marque Marketo Sync User (Usuário de sincronização do Marketo) e clique em OK.
...
1. Em **Configurações**, clique em **Marketo Config**.
   ...
   >[!NOTE]
   >
   >Se a configuração do Marketo estiver ausente, tente atualizar a página. Se o problema persistir, [publique a Solução do Marketo](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-1-of-3-install.md) ou tente sair e entrar novamente.
