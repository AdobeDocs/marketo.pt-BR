...
1. Selecione a solução apropriada para sua versão do Microsoft Dynamics.
   ...
   Fantástico! Um arquivo zip da solução agora será baixado para o dispositivo. Se você não estiver familiarizado com as etapas de instalação, entre em contato com o administrador do Dynamics.
