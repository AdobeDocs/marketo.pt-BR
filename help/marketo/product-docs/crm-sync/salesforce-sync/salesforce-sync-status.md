---
description: Saiba mais sobre o painel Status de sincronização do Salesforce e como visualizar estatísticas de sincronização. Filtre por data, tipo de operação ou tipo de objeto e exporte erros de sincronização como CSV.
...
1. Em [!UICONTROL Integração], clique em **Salesforce** e, em seguida, na guia **[!UICONTROL Status de sincronização]**.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1">Pessoa (lead)*</td>
   <td colspan="1">Extraia ações de conversão do SFDC para o Marketo. Unidades (números) são clientes em potencial que convertem em Contatos</td>
  ...
  <tr>
   ...
   <td colspan="1">Registros excluídos de SFDC que estão sendo sincronizados com o Marketo</td>
  ...
  <tr>
   ...
   <td colspan="1">Envio de atualizações para o SFDC e também exclusões</td>
   <td colspan="1">Atualização, item com falha ou ignorado</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="1">Sincroniza o programa Marketo com as campanhas do SFDC</td>
   <td colspan="1">Novo, Atualizações, Falha ou Ignorado</td>
  </tr>
  <tr>
   <td colspan="1">Atualizar atividades</td>
   <td colspan="1">Tarefas</td>
   <td colspan="1">Atividades de pull do Salesforce</td>
   <td colspan="1"></td>
  </tr>
  <tr>
