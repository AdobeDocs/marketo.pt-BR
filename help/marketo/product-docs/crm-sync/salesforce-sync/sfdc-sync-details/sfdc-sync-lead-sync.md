...
description: Saiba mais sobre como a sincronização de clientes potenciais funciona entre o Salesforce e o Marketo. Entenda a sincronização bidirecional, crie leads no Marketo e respeite as regras de validação.
