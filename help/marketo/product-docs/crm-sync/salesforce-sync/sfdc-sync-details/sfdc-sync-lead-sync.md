...
Você sabia que o Marketo sincroniza com seu banco de dados do Salesforce? Ele sincroniza, aguarda 5 minutos e sincroniza novamente. O dia todo, todos os dias. Estes são alguns detalhes sobre como o Marketo trata os clientes potenciais do Salesforce especificamente.
...
Sim, use o [Sincronizar pessoa ao SFDC](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/sync-person-to-sfdc.md) ação de fluxo. Isso criará um cliente em potencial no Salesforce se o cliente em potencial não existir.
