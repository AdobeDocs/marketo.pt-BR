...
# Como corresponder aos status do programa e status da campanha do Salesforce antes de sincronizar {#how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync}
...
## O que você fará se receber uma mensagem de erro {#what-do-you-do-if-you-received-an-error-message}
