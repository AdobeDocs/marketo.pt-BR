...
description: Saiba mais sobre como sincronizar programas do Marketo com campanhas do Salesforce. Mapeie programas para campanhas e mantenha membros e status sincronizados entre ambos os sistemas.
