---
description: Saiba mais sobre as métricas de backlog de sincronização do Salesforce e como monitorar registros com sincronização pendente. Visualize a tendência e a taxa de transferência do backlog por tipo de objeto no Admin e no Salesforce.
