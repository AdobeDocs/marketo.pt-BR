...
description: Saiba como personalizar quais atividades o Marketo envia para o Salesforce. Ative os tipos de atividade em Admin e Opções de sincronização para criar o histórico de atividades do Salesforce a partir de eventos.
