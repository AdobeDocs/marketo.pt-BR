...
# Tornar o usuário de sincronização do Marketo um usuário de marketing {#make-marketo-sync-user-a-marketing-user}

O [Marketo sync user](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md) precisa ser um usuário de Marketing para que a sincronização de campanha do Salesforce funcione corretamente. Veja como tornar o usuário um usuário de Marketing no Salesforce.
