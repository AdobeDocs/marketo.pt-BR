---
description: Noções básicas sobre a sincronização Veeva - Documentos do Marketo - Documentação do produto
title: Entendendo a sincronização Veeva
hide: true
hidefromtoc: true
...
# Entendendo a sincronização Veeva {#understanding-the-veeva-sync}
...
## O que é sincronizado entre o Marketo e Veeva {#what-is-synced-between-marketo-and-veeva}

Objetos Personalizados de Chamadas e Chamadas de Objetos-Chave de Contas de Pessoas
