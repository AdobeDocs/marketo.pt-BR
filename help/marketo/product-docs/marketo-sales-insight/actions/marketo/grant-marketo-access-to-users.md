---
description: Saiba como conceder acesso ao Marketo a usuários em Ações do Sales Insight. Permite que os usuários vejam os dados do Marketo e usem recursos conectados à Marketo.
