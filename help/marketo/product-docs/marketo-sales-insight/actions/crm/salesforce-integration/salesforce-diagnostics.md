...
**O que está acontecendo:** Não há acesso ao registro pai de uma tarefa.
**Etapas de Solução de Problemas:** Veja acima.
...
**Etapas de Solução de Problemas:** A lógica de repetição deve tratar disso. Se ele ainda não estiver funcionando, trabalhe com seu administrador [!DNL Salesforce] para solucionar um disparador problemático.
