---
description: Saiba como desinstalar o pacote de personalização do Salesforce Lightning para o Sales Insight. Remova o pacote da instância do Salesforce quando necessário.
