---
description: Solucionar problemas quando os campos dinâmicos não preencherem os modelos. Verifique a conexão e o mapeamento de campos do Salesforce para campos de mesclagem.
