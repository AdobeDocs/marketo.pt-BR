---
description: Saiba mais sobre os motivos da chamada em Ações do Sales Insight. Defina um motivo ao fazer uma chamada para que ela seja conectada no Marketo e no Salesforce.
