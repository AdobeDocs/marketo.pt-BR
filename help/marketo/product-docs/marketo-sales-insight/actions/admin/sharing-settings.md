...
1. Certifique-se de **Configurações de compartilhamento** estiver ativado. Isso significa que, por padrão, somente os Administradores poderão compartilhar modelos nas categorias de modelo.
...
1. Agora que sua equipe foi adicionada, você pode optar por permitir que somente administradores de equipe compartilhem ou todos os usuários dessa equipe. Neste exemplo, estamos dando acesso ao compartilhamento de acesso a todos os usuários da equipe de SDR.
