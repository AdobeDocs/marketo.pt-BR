---
description: Saiba como conectar um novo administrador ao Marketo e transferir a integração do Marketo. Siga as etapas para desconectar o administrador atual e estabelecer uma nova conexão.
