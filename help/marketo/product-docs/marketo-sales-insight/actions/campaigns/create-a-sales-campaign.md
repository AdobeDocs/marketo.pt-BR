...
* **Medida**: controle o sucesso de todos os seus emails e tarefas em um único local enquanto os registra automaticamente no Salesforce. Ao conhecer o que está repercutindo e levando a resultados, você pode testar e melhorar seus resultados de forma consistente.
...
1. Selecione uma categoria e clique no botão **Criar nova campanha**.

   ![](assets/create-a-sales-campaign-2.png)

   >[!NOTE]
   >
   >Crie uma nova categoria clicando em **+** ao lado de **Categorias**.
...
1. Quando você [terminar seu email](/help/marketo/product-docs/marketo-sales-insight/actions/campaigns/sales-campaign-step-types-and-reminder-tasks.md#email){target="_blank"}, clique em **Adicionar**.
...
1. Certifique-se de personalizar o agendamento e as opções de resposta, como ignorar fins de semana (o que é ótimo), acessando a **Guia Configurações** da sua Campanha de Vendas.
