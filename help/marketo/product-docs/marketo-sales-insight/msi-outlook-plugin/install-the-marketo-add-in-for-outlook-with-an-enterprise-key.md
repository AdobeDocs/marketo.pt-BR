...
# Instalar o Suplemento Marketo para [!DNL Outlook] com uma Chave Corporativa {#install-the-marketo-add-in-for-outlook-with-an-enterprise-key}

Muitas vezes, os representantes de vendas não têm privilégios administrativos em seus laptops e suas equipes de TI são responsáveis pela instalação remota de todos os softwares. O Suplemento Marketo para Outlook pode ser instalado dessa maneira usando sua Chave corporativa, que pode ser encontrada na seção Sales Insight de Admin. Se você não vir o botão Exibir Chave Corporativa, contate o [Suporte da Marketo](https://nation.marketo.com/t5/Support/ct-p/Support) para habilitá-lo.

>[!PREREQUISITES]
>
>O administrador deve ter [emitido uma Licença do Suplemento de Email da Marketo](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md).
...
1. Clique em **[!UICONTROL Exibir Chave da Empresa]**.

   ![](assets/image2016-7-25-14-3a35-3a38.png)

1. Copie a Chave de Licença [!DNL Outlook Enterprise] e cole-a em um email, juntamente com [este link](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md), e envie-a ao seu departamento de TI para instalação remota.
