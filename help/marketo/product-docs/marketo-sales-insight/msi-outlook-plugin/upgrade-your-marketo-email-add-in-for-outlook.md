...
>[!NOTE]
>
>A partir de 01/10/20, a versão mais recente do plug-in [!DNL Outlook] não oferecerá mais suporte ao modo offline. Isso entrará em vigor após a instalação/atualização em ou após 10/1.

## Baixar instalador {#download-installer}

Baixe o instalador apropriado para sua versão do Microsoft [!DNL Outlook].
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td><span class="dnl">Outlook</span> para Mac</td> 
   <td>Não suportado</td> 
   <td>Não suportado</td> 
   <td>Não suportado</td> 
   <td>Não suportado</td> 
  ...
  <tr> 
   <td colspan="1">Aplicativo Web <span class="dnl">Outlook</span></td> 
...
1. Clique em **[!UICONTROL Avançar]**.
   ...
   >[!NOTE]
   >
   >Em certos casos, os dados estarão ausentes. Copie do email de registro e feche [!DNL Outlook].

1. Fechar [!DNL Microsoft Outlook].

   ![](assets/ent-key-close-outlook-hand.png)

1. Você perceberá que todas as suas informações estão pré-preenchidas. Basta clicar em **[!UICONTROL Avançar]**.
...
1. Agora abra o [!UICONTROL Microsoft Outlook] para ver a versão mais recente dos botões do Marketo.

   ![](assets/image2016-8-24-15-3a47-3a38.png)

>[!MORELIKETHIS]
>
>* [Enviar e Rastrear um Email com o Suplemento de Email do Marketo para [!UICONTROL Outlook]](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-an-email-with-the-email-add-in-for-outlook.md)
>* [Enviar e Rastrear do [!UICONTROL Outlook] Usando um Modelo do Marketo](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-from-outlook-using-a-marketo-template.md)
