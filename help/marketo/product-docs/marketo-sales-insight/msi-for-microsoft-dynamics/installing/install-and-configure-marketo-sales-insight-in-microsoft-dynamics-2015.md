...
description: Instalar e configurar o Marketo Sales Insight no Microsoft Dynamics 2015 - Documentos do Marketo - Documentação do produto
...
O Marketo Sales Insight é uma ferramenta fantástica para dar à sua equipe de vendas uma &quot;janela&quot; sobre a riqueza de dados que a equipe de marketing tem. Veja como instalá-lo e configurá-lo no Microsoft Dynamics 2013
...
1. Copie o **Host Marketo**, **URL da API** e **ID de usuário da API** para uso em uma etapa posterior. Insira uma chave secreta de API de sua escolha e clique em **Salvar**.
   ...
   >[!NOTE]
   >
   >Os seguintes campos devem ser sincronizados com o Marketo para *Tanto o Cliente Potencial como o Contato* para que o Sales Insight funcione:
   >
   >* Prioridade
   >* Urgência
   >* Pontuação relativa
