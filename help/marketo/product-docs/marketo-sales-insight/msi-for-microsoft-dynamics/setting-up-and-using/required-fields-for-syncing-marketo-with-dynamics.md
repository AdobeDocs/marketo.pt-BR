...
description: Saiba mais sobre os campos obrigatórios para sincronizar o Marketo com o Dynamics. Verifique se os campos corretos estão mapeados para que o MSI funcione corretamente.
