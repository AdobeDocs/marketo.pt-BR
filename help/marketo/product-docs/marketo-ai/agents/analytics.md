...
* As respostas do Analytics são baseadas nos dados disponíveis na instância do Marketo. Se um programa não for rastreado ou uma métrica não for capturada, a IA do Marketo não poderá relatar isso.
