...
Para acessar a IA do Marketo, os administradores devem primeiro habilitar as permissões de função.
...
1. Role para baixo e marque a caixa de seleção **Acessar compilação com IA** e clique em **Salvar**.
