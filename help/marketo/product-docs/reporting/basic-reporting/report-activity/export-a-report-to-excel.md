...
description: Saiba como exportar relatórios para arquivos do Excel para análise em outro software. Clique no botão Exportar na guia Relatório para baixar os dados.
