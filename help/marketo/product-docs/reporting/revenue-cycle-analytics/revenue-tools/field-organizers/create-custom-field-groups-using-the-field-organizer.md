...
description: Saiba como criar grupos de campos personalizados usando o organizador de campos no Marketo Engage e criando grupos de campos personalizados. Use este guia para concluir a próxima etapa.
