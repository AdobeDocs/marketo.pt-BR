...
# Definir conversões do Google AdWords no modelo de receita com uma conta do gerente {#set-google-adwords-conversions-in-the-revenue-model-with-a-manager-account}
...
1. Defina uma **Conversão AdWords**.
   ...
   Dica: Se você não tiver conversões de AdWords, crie uma clicando em **+Nova conversão**.
...
1. Selecione a **Conta AdWords** desejada e **Conversão AdWords** desejada para cada estágio que você deseja rastrear.
