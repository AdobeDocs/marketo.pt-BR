...
description: Saiba como aprovar/cancelar a aprovação de um modelo de receita no Marketo Engage usando o modelo de receita de aprovação. Use este guia para concluir a próxima etapa.
