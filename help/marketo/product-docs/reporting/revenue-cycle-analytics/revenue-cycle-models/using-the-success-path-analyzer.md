...
1. Clique em **Em Fluxo** para desenhar o gráfico de quantas pessoas entraram no palco durante o período selecionado.
...
1. Selecione a data **De** para o período de comparação.
   ...
   A data **To** é definida automaticamente para corresponder à duração do período de tempo original.
...
1. Para alterar a escala de tempo do gráfico, clique em um dos botões **Graph by**: diário (padrão), semanal e mensal
