...
Avalie a contribuição [da Marketing para a receita](/help/marketo/product-docs/reporting/performance-insights/performance-insights-contribution-overview.md) em função da aquisição, influência, conversão, até mesmo do crescimento básico instalado pelo cliente.
...
Descubra as [tendências de longo prazo](/help/marketo/product-docs/reporting/performance-insights/performance-insights-trend-overview.md) para descobrir estratégias vencedoras consistentes.

![](assets/4.png)

## Configurações {#settings}

Nos painéis de Receita e Pipeline, clique no ícone [Configurações](/help/marketo/product-docs/reporting/performance-insights/performance-insights-settings.md) para definir parâmetros adicionais.
