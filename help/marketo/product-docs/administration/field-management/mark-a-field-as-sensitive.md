---
description: Marque os campos como confidenciais para que seus valores nunca sejam preenchidos previamente em formulários para proteger os dados do usuário.
...
# Marcar campo como confidencial {#mark-a-field-as-sensitive}
