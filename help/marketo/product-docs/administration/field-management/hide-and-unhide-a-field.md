...
1. Localize o campo, selecione-o e, em **Ações do campo** clique em **Ocultar campo**.
...
1. Localize e selecione o campo . Na lista suspensa Ações do campo , clique em **Mostrar campo**.
