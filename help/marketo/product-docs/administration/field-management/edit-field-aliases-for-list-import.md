...
# Editar alias de campo para importação de Lista {#edit-field-aliases-for-list-import}

Ao importar uma lista com cabeçalhos desconhecidos, é possível criar alias de campo para facilitar a operação. Você também pode editar esses alias no gerenciamento de campos. Confira.
