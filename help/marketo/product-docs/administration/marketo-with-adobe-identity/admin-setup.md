---
description: Etapas de configuração inicial para administradores de sistema do Adobe após serem adicionadas ao Marketo Engage, incluindo a criação de um perfil de produto no Adobe Admin Console.
