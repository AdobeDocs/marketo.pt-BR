...
[Remover um usuário](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user){target="_blank"}
...
[Adicionar usuário somente de API para assinaturas habilitadas para o Adobe IMS](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md){target="_blank"}
