---
description: Visão geral do Adobe Identity Management para Marketo Engage, incluindo tempo de migração, gerenciamento de usuários do Admin Console e níveis de perfil, como Administrador do sistema e Administrador do produto.
...
<table>
 ...
 <tr>
  ...
  <td>Uma pessoa que recebeu acesso ao Marketo Engage com privilégios Administrativos. Função concedida no Marketo Engage, não no Adobe Admin Console (aparece somente como "Administrador" no modal <b>Editar usuário</b>).</td>
 </tr>
 <tr>
...
>* [Adicionar ou remover um usuário](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}
