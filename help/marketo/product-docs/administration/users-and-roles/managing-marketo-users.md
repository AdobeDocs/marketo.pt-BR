...
>[!IMPORTANT]
>
>Este artigo é somente para quem _não_ usa a [Marketo com a Adobe Identity](/help/marketo/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.md){target="_blank"}. Se você fizer isso, siga as etapas em [este artigo](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}.
...
>[!NOTE]
>
>Se o usuário que você deseja excluir também for um usuário do Dynamic Chat, [remova-o do Dynamic Chat](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#remove-a-chat-user){target="_blank"} no Admin Console antes de excluí-lo no Marketo Engage.
