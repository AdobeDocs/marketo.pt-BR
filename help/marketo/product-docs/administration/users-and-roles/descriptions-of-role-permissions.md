...
description: Lista de referência de todas as permissões de função no Marketo, incluindo Admin de acesso, API de acesso e outros grupos de permissão que você pode atribuir ao criar ou editar funções.
