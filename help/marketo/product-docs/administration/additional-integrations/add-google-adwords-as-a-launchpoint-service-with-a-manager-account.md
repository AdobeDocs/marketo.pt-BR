...
1. Conversão de atributo para a **Primeiro clique** ou **Último clique**.
   ...
   >[!NOTE]
   >
   >[Marcação automática](https://support.google.com/adwords/answer/1752125?hl=en){target=&quot;_blank&quot;} deve ser selecionado para que esse recurso funcione. Ele deve ser ativado no AdWords.
