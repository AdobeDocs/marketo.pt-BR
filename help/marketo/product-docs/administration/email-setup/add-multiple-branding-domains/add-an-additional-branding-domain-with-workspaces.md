...
description: Adicione outros domínios de marca e atribua um domínio principal por espaço de trabalho ao usar espaços de trabalho.
...
1. Insira um novo domínio de marca. Clique em **[!UICONTROL Next]**.
