...
description: Lista de navegadores e versões compatíveis com o Marketo Engage, incluindo Chrome, Firefox, Safari e Edge, com uma observação para usuários do Adobe Identity.
