...
description: Como aprovar objetos personalizados novos ou editados no Admin, incluindo requisitos para objetos do tipo um para muitos, muitos para muitos e intermediários.
