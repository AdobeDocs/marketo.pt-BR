...
description: Saiba mais sobre o Relatório de resumo que fornece uma visualização mensal do desempenho do conteúdo da campanha e do conteúdo recomendado. Rastreie cliques, conversões diretas, conversões assistidas e compare resultados com meses anteriores.
