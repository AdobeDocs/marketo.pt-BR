...
1. Selecionar **Tela em branco**, adicionar um **Nome do painel** e clique em **Criar painel**.
...
1. Crie um novo painel chamado **Painel B2B RTP** e define os seguintes widgets:
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Filtro: <br>Somente mostrar | Categoria de evento (contendo) segmentos RTP</li> 
  ...
  <tr> 
   ...
   <th> 
    <ul> 
     ...
     <li>Exibir as seguintes colunas: <br>Rótulo do evento | Sessões | Taxa de conversão da meta</li> 
     <li>Filtro: <br>Somente mostrar | Categoria de evento (contendo) segmentos RTP</li> 
...
Crie um novo painel chamado **Painel de Envolvimento RTP** e define os seguintes widgets:
...
<table> 
 <thead> 
  <tr> 
   <th> 
    <div> <strong>Coluna 1 — Exposição a Campanhas</strong> 
    </div></th> 
   <th> 
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Filtros:<br><strong>[mostrar apenas] Categoria de evento (contém): RTP-Campanhas</strong><br><strong>[mostrar apenas] Ação do evento (correspondência exata): Impressão</strong><strong>[não mostrar] Rótulo de evento (contendo): #</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>Tipo: <strong>2.1 Métrica </strong></li> 
     <li>Mostrar a seguinte métrica: <strong>Total de eventos</strong></li> 
     <li>Filtros:<br><strong>[mostrar apenas] Categoria de evento (contém): RTP-Campanhas</strong><br><strong>[mostrar apenas] Ação do evento (correspondência exata): Cliques</strong><strong>[não mostrar] Rótulo de evento (contendo): #</strong></li> 
  ...
  <tr> 
   <td colspan="1"> 
    <ul> 
     ...
     <li>Filtros:<br><strong>[mostrar apenas] Categoria de evento (correspondência exata): RTP-Campanhas</strong><br><strong>[mostrar apenas] Ação do evento (correspondência exata): impressão</strong><strong>[não mostrar] Rótulo de evento (contendo): #</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     ...
     <li>Tipo: <strong>2.1 Métrica </strong></li> 
     <li>Mostrar a seguinte métrica: <strong>Média Duração da sessão</strong></li> 
     <li>Filtros:<br><strong>[mostrar apenas] Categoria de evento (correspondência exata): RTP-Campanhas</strong><br><strong>[mostrar apenas] Ação do evento (correspondência exata): cliques</strong><strong>[não mostrar] Rótulo de evento (contendo): #</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     <li>Nome: <strong>CRE - Principais conteúdos recomendados</strong></li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>Tipo: <strong>Tabela</strong></li> 
     <li>Exibir as seguintes colunas: <strong>Rótulo do evento | Total de eventos | Usuários</strong></li> 
     <li>Filtros:<br><strong>[mostrar apenas] Categoria de evento (correspondência exata): RTP-Campanhas</strong><br><strong>[mostrar apenas] Ação do evento (correspondência exata): cliques</strong></li> 
...
>[!MORELIKETHIS]
>
>[Integrar o RTP ao Google Universal Analytics](/help/marketo/product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/custom-rtp-reports-in-google-universal-analytics.md)
>
