...
Para testar suas campanhas personalizadas de forma A/B, você pode selecionar duas ou mais campanhas, associá-las à mesma **Teste de Divisão** e selecione **Ajuste automático** para continuar automaticamente com a campanha com melhor desempenho.
...
1. **Salvar** ou **Launch** a campanha.
   ...
   >[!TIP]
   >
   >Selecionar **Ajuste automático** O permite que a plataforma de Personalização da Web reconheça automaticamente a campanha de teste dividida de melhor desempenho e continue com a campanha de conversão mais alta enquanto pausa as outras.
...
1. No **Definir campanha** selecione **Teste de divisão** e escolha o **Grupo** no menu suspenso. Selecionar **Ajuste automático**.
...
1. Entrada **Campanhas da Web** você pode ver as campanhas de teste divididas indicadas pelo ícone A/B.
