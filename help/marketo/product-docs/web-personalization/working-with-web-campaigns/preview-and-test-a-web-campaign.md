...
description: Saiba como pré-visualizar e testar uma campanha da Web no Marketo Engage usando a pré-visualização e o teste de uma campanha da Web. Use este guia para concluir a próxima etapa.
