...
description: Saiba como clonar uma campanha da Web no Marketo Engage usando a opção clone uma campanha da Web clone-a-web-campaign. Use este guia para concluir a próxima etapa.
