...
Para novos clientes do Marketo, o [!UICONTROL Real-Time Personalization] é dividido em quatro aplicativos, acessados por meio destes dois blocos: [!UICONTROL Web Personalization] e [!UICONTROL ContentAI].

![](assets/pasted-image-at-2016-03-23-02-45-pm.png) ![](assets/mlm-homepage-content-ai-281-29.png)

>[!NOTE]
>
>O [!UICONTROL Web Personalization] e o [!UICONTROL ContentAI] estão disponíveis em todos os idiomas com suporte da Marketo (inglês, francês, alemão, japonês, português e espanhol).
...
Ao clicar no bloco [!UICONTROL Web Personalization], a página Painel é exibida. Clique no bloco [!UICONTROL IAdeConteúdo] e vá diretamente para a página Recomendações de Conteúdo.

Os quatro aplicativos são:

* [!UICONTROL Web Personalization]
* [!UICONTROL Marketing pela Web baseado em conta]
* [!UICONTROL Redirecionamento de Site]
* [!UICONTROL IAdeConteúdo]

O bloco **[!UICONTROL Web Personalization]** é seu ponto de acesso para criar campanhas personalizadas da Web. Marketing pela Web baseado em conta e redirecionamento pela Web. Você pode adicionar conteúdo na página do Content Analytics.

O **[!UICONTROL Marketing pela Web baseado em conta]** funciona com o Web Personalization e com recursos de Contas nomeadas. A página Contas nomeadas fornece informações gráficas sobre clientes existentes, total de engajamentos e tendências organizacionais, bem como uma lista das contas. Você também pode criar novas contas nomeadas lá.

**[!UICONTROL Redirecionamento de site]** dá a você o poder de recomercializar para públicos segmentados. Você pode definir segmentos, mas não pode usar Contas nomeadas no filtro.

**[!UICONTROL ContentAI]** é o local para fornecer recomendações de conteúdo. É possível adicionar conteúdo facilmente à página Recomendações de conteúdo.

>[!NOTE]
>
>Para acessar o [!UICONTROL Marketing pela Web baseado em conta] ou o [!UICONTROL Redirecionamento de Sites], você deve clicar no bloco [!UICONTROL Web Personalization], mesmo se não tiver o aplicativo [!UICONTROL Web Personalization].
...
Isso ativa a sobreposição [!UICONTROL Compartilhar esta Organização], na qual você pode enviar um email compartilhando o nome e os detalhes da organização que visitou o site.
...
A página Visitantes exibe todos os detalhes e o comportamento online de cada visitante que chegou ao site no período de tempo determinado. A página oferece uma insight detalhada sobre as atividades e o comportamento online de cada visitante. Os dados do visitante na tabela são atualizados dentro de 24 a 48 horas.
