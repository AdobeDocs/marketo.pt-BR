...
1. No editor de oferta de referência, acesse **Rastrear fluxo de progresso** > **Redes sociais**.

   ![](assets/image2014-9-22-14-3a35-3a43.png)

1. No **Exibir e editar** editar o prompt que lembra os participantes a entrarem na mesma rede social que eles usaram para se inscreverem na sua oferta.

   ![](assets/image2014-9-22-14-3a35-3a58.png)

   >[!NOTE]
   >
   >Para realçar o texto que pode ser editado, selecione **Mostrar edições** no canto superior direito.
...
>[!MORELIKETHIS]
>
>Clique em **Concluir** > **Aprovar e fechar** e [publicar sua oferta de referência](/help/marketo/product-docs/demand-generation/social/referral-offers/publish-a-referral-offer.md).
