---
description: Obtenha ajuda sobre acesso, instalação, retenção de dados e suporte de idioma do Dynamic Chat. Encontre respostas para perguntas comuns sobre o Marketo Engage Dynamic Chat.
