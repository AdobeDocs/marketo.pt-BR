...
1. Depois de fazer logon no Admin Console, a próxima ação a ser executada é adicionar usuários. Temos esse processo [documentado aqui](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#add-a-chat-user){target="_blank"}.
