---
description: Saiba como adicionar ou remover usuários do Dynamic Chat na Adobe Admin Console. Atribua perfis de produto e gerencie o acesso da sua equipe.
...
Se a função Marketo do usuário de Chat recém-adicionado ainda não tiver a permissão [!DNL Dynamic Chat], siga estas etapas para adicioná-lo.
