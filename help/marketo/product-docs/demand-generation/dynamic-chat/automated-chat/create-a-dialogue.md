---
description: Saiba como criar uma nova caixa de diálogo no Dynamic Chat. Escolha um modelo, defina o nome e a prioridade e crie um fluxo para sua conversa.
...
Siga estas etapas para criar uma nova caixa de diálogo.
