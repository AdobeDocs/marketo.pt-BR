---
description: Saiba como usar atributos de pessoa do Demandbase no Dynamic Chat para direcionamento e roteamento de diálogo. Obtenha sua chave de API e habilite a integração.
title: Demandbase
