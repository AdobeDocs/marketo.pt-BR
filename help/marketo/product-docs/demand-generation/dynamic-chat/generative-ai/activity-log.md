---
description: Saiba mais sobre o log de atividades da IA gerativa no Dynamic Chat. Exibir todas as tarefas, proprietários, tipos e editar o histórico em um único local.
