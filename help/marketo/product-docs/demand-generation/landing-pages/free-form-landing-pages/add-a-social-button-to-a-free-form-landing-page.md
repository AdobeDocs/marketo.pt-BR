...
1. Selecione **[!UICONTROL Botões sociais (com o Analytics)]**.
   ...
   Depois que a landing page estiver ativa, você poderá visualizar a atividade gerada pelo botão social (com o Analytics) no Painel social.
...
1. Publique a página de aterrissagem [no Facebook](/help/marketo/product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md) e coloque o botão social em seu site.

Você adicionou um botão de rede social à página de aterrissagem. Aprove a landing page quando estiver pronto.
