...
description: Saiba como criar um evento com a Reunião na Web de Nível 3 no Marketo. Configure o registro da reunião da Web de integração e sincronização com o Marketo.
...
>[!PREREQUISITES]
>
>* [Adicionar [!DNL Level 3 Web Meeting] como um [!DNL LaunchPoint] Serviço](/help/marketo/product-docs/administration/additional-integrations/add-level-3-web-meeting-as-a-launchpoint-service.md)
...
1. Selecione o novo evento. Clique em **[!UICONTROL Ações de Evento],** e depois em **[!UICONTROL Configurações de Evento].**

   ![](assets/image2016-3-24-15-3a40-3a39.png)

1. Em [!UICONTROL Parceiro de Evento], selecione **[!UICONTROL Reunião Web de Nível 3]**.

   ![](assets/image2016-3-24-15-3a42-3a10.png)

1. Em [!UICONTROL Logon], selecione seu logon do [!DNL Level 3].

   ![](assets/image2016-3-24-15-3a43-3a43.png)

1. Em [!UICONTROL Evento], escolha o evento [!DNL Level 3] que deseja usar.
