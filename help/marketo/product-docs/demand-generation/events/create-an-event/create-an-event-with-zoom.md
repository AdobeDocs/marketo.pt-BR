...
Depois que você criar um evento de marketing e associar um webinar de zoom a ele, os sistemas poderão compartilhar informações de inscrição e presença. Para obter ajuda para criar um webinar, consulte [Introdução aos webinars de zoom](https://support.zoom.us/hc/en-us/articles/200917029-Getting-Started-With-Webinar).
...
* **Registro**  - Marque esta caixa para tornar o registro obrigatório. Você usará um formulário/landing page de marketing para capturar informações de registro que serão enviadas para Zoom.
...
>[!TIP]
>
>Há campos adicionais que você configurará no Zoom que NÃO afetarão a integração. Consulte o [Centro de ajuda do Webinar de zoom](https://support.zoom.us/hc/en-us/sections/200324965-Video-Webinar) para obter informações adicionais sobre esses campos.
