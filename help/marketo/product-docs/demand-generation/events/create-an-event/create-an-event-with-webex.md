...
Primeiro, crie um Evento Webex no Centro de eventos Webex. O Marketo usa apenas configurações e campos específicos para sua integração, que abordaremos em breve. Outros campos que você pode querer configurar para o Webex são explicados na seção [Guia do usuário do Centro de eventos Webex](https://www.cisco.com/c/dam/en/us/td/docs/collaboration/meeting_center/wbs298/wx_ec_host_ug.pdf).
...
* **Registro -** Marque esta caixa para definir como &quot;obrigatório&quot;. Você usará um formulário/página de aterrissagem do Marketo para capturar informações de registro que serão enviadas para o Webex.
