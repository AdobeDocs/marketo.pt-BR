...
description: Noções básicas sobre os eventos do adaptador Marketo On24 - Documentação do Marketo - Documentação do produto
title: Noções básicas sobre os eventos do adaptador Marketo On24
...
# Noções básicas sobre os eventos do adaptador Marketo On24 {#understanding-marketo-on-adapter-events}
...
Esses artigos o guiarão pelo processo de criação de um webinário no ON24, criação de um evento no Marketo e associação deles.

O gráfico abaixo descreve o processo de integração.

![](assets/image2015-12-16-11-3a26-3a29.png)

Pronto para começar? Iniciar com [Crie um evento com o adaptador ON24](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter.md){target="_blank"}.
