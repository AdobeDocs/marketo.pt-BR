...
description: Saiba como testar a integração do evento ON24 com o Marketo. Verifique se a sincronização, o fluxo de registro e as atualizações de status funcionam corretamente.
...
Teste sua integração de eventos completamente.
...
A seguir, é descrito como os dados são atualizados após a ocorrência do evento:
