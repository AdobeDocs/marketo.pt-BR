---
description: Saiba como definir um limite de eventos no Marketo. Limite o número de inscritos ou participantes do seu programa de eventos.
...
1. Clique no menu suspenso **[!UICONTROL Página completa de registro]** e selecione a página de aterrissagem que atuará como a página completa de registro. Clique em **[!UICONTROL Definir e Habilitar]** quando terminar.
   ...
   Tudo pronto. Se decidir editar os detalhes do limite de eventos, clique no texto azul ao lado de [!UICONTROL Limite de eventos].
