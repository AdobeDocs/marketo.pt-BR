---
description: Saiba como enviar uma lista estática para o LinkedIn, Facebook ou Google. Use Ações de lista e Enviar para rede de publicidade para escolher opções de público-alvo e sincronização.
...
1. Escolha entre [!DNL LinkedIn], [!DNL Facebook] ou Google (as outras opções não estão disponíveis no momento). Neste exemplo, estamos escolhendo **[!DNL LinkedIn]**. Clique em **[!UICONTROL Next]**.
