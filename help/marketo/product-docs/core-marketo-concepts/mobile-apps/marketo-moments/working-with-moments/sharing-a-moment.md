...
description: Compartilhamento de um momento - Documentação do Marketo - Documentação do produto
...
1. Toque no **[!UICONTROL Compartilhar]** no cartão.

   ![](assets/image2015-6-30-15-3a13-3a13.png)

1. Toque no menu do cartão e em **[!UICONTROL Compartilhar]** na tela Detalhes.
...
1. Insira o endereço, um assunto e toque do destinatário **[!UICONTROL Enviar]**.
