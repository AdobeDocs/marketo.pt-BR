...
description: Saiba mais sobre os cartões do Smart Campaign no Marketo Moments. Visualize o status da campanha e execute as etapas de fluxo do aplicativo móvel.
