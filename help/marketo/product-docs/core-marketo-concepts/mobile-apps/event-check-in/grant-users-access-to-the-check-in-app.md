...
description: Saiba como conceder aos usuários acesso ao aplicativo Check-in de eventos. Atribua a função Check-in do evento para dispositivos móveis para que eles possam fazer check-in dos participantes.
...
1. Insira as informações do novo usuário. Marque as caixas de seleção de todas as funções apropriadas e a nova função com a permissão para acessar o aplicativo móvel. Clique em **[!UICONTROL Convidar]** quando terminar.
   ...
   >[!TIP]
   >
   >Para usuários existentes, você pode criar uma nova função ou adicionar a permissão [!UICONTROL Acessar Aplicativo Móvel] à função atual.
