---
description: Saiba mais sobre o Check-in de eventos para fazer o check-in de clientes de um tablet. Use o aplicativo Check-in para gerenciar o registro de eventos.
...
O aplicativo Eventos da Marketo para [!DNL iPad] ou [!DNL Android] tablet facilita o check-in imediato das pessoas quando elas chegam ao seu evento.
...
## Configurar o [!DNL iPad] ou o [!DNL Android] tablet

Para preparar o tablet [!DNL iPad] ou [!DNL Android]:

* Baixe e instale o aplicativo tablet Marketo Events [!DNL iPad] ou [!DNL Android]
...
* [Fazer check-in de convidados](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md){target="_blank"} (reverter check-ins, editar registros de pessoas no check-in)
* Sincronizar o aplicativo tablet [!DNL iPad] ou [!DNL Android] com o Marketo
