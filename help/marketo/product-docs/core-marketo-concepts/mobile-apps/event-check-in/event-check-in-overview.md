...
O aplicativo Eventos da Marketo para [!DNL iPad] ou [!DNL Android] O tablet facilita o check-in imediato das pessoas quando elas chegam ao seu evento.

Este artigo descreve o processo completo. Os cabeçalhos são vinculados aos artigos separados e algumas atividades do Marketo são links neste outline.
...
* [Criar uma nova função do Marketo](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md){target="_blank"} para [!DNL iPad] ou [!DNL Android] usuários para o evento
...
## Configurar o [!DNL iPad] ou [!DNL Android] Tablet

Para obter a [!DNL iPad] ou [!DNL Android] tablet pronto:

* Baixe e instale os eventos do Marketo [!DNL iPad] ou [!DNL Android] aplicativo tablet
...
## Verificar pessoas usando o [!DNL iPad] ou tablet

No evento:

* Fazer logon no aplicativo
* Localizar convidados (e criar novas pessoas)
* [Fazer check-in de convidados](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md){target="_blank"} (estornar check-ins, editar registros de pessoas no check-in)
* Sincronizar o [!DNL iPad] ou [!DNL Android] aplicativo tablet com Marketo
