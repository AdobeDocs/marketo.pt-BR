...
Neste exemplo, vamos adicionar algumas restrições a um **[Valor de dados alterado](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md)** para localizar pessoas que tiveram uma alteração de Status do MQL para o SQL.
...
1. Selecione a lista inteligente com um filtro ao qual você adicionará uma restrição e clique no botão **Lista inteligente** guia .
...
1. Muito bem! Clique no botão **Pessoas** para ver todas as pessoas que tinham uma **Status** alterar de **MQL** para **SQL** nos últimos 30 dias.
