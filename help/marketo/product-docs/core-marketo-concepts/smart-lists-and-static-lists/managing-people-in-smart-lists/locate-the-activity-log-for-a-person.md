...
O registro de atividades é a fonte definitiva da verdade. Esta é a história completa da jornada de uma pessoa no Marketo.
...
1. Clique em **Pessoas** guia. Selecione uma pessoa **ID** número.
...
1. Um arquivo do Excel é baixado no navegador.
   ...
   >[!MORELIKETHIS]
   >
   >Saiba mais sobre [filtragem do registro de atividades](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/filter-activity-types-in-the-activity-log-of-a-person.md) para ver atividades específicas da pessoa.
