...
description: Saiba como usar a página de detalhes da pessoa. Exibir e editar informações de cliente potencial, atividade e etapas de fluxo de execução de um único local.
