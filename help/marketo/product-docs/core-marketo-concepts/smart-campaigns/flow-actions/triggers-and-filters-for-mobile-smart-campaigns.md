...
# Acionadores e filtros de campanhas inteligentes para dispositivos móveis {#triggers-and-filters-for-mobile-smart-campaigns}
...
O filtro tem esta aparência no Marketo:
