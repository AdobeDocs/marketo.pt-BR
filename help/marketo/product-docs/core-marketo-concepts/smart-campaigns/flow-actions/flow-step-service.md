---
description: Saiba mais sobre o Serviço de etapa de fluxo para etapas de fluxo personalizadas. Estenda as Campanhas inteligentes com ações personalizadas por meio da API.
