...
1. Na campanha inteligente, clique em **Resultados**.
   ...
   >[!TIP]
   >
   >Você pode ver a lista de pessoas que foram processadas pela campanha inteligente clicando em [Exibir membros da campanha](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-smart-campaign-members.md).
...
1. Clique em uma **ID** para exibir mais detalhes sobre essa atividade específica.
   ...
   >[!MORELIKETHIS]
   >
   >[Filtrar resultados de campanha inteligente](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/filter-smart-campaign-results.md)
