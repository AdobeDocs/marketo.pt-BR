...
>[!CAUTION]
>
>Se você mover uma Campanha inteligente de um programa para outro e as Etapas da lista inteligente ou do fluxo da campanha fizerem referência ao programa original, será necessário atualizar manualmente as informações para refletir o novo programa, pois elas refletirão **não** atualização automática.
