...
description: Saiba como criar uma nova Campanha inteligente. Configure acionadores para uma Smart List e adicione etapas de fluxo para automatizar ações.
