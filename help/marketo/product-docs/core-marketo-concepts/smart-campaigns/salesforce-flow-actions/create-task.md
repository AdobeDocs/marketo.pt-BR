...
>[!NOTE]
>
>Quando o usuário do Marketo Sync está criando tarefas, **Em** é um campo obrigatório para a tarefa a ser criada no Salesforce. Por padrão, o Marketo inserirá cinco dias se não houver valor.
