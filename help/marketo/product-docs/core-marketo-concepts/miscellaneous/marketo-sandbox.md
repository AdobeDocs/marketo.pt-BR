...
# Área de segurança do Marketo {#marketo-sandbox}
...
Uma caixa de proteção Marketo não pode ser sincronizada com seu CRM regular se já estiver sincronizada com sua instância de produção. Use a caixa de proteção do CRM para sincronizar e siga [todas as etapas](http://docs.marketo.com/display/DOCS/CRM+Sync) da sincronização original.
...
* Se você quiser adicionar usuários, o processo é o mesmo que [adicionar usuários na produção](http://docs.marketo.com/display/DOCS/Managing+Marketo+Users#ManagingMarketoUsers-CreateUsers). Novamente, eles devem usar um endereço de email diferente se já tiverem um logon do Marketo.
...
* Se você criar um programa em sua caixa de proteção e quiser movê-lo para a produção, é possível realizar uma importação [de](http://docs.marketo.com/display/DOCS/Import+a+Program)programa.
