---
description: Modelo do programa informativo. Use-o para receber informativos por email com nomes padrão.
...
# NL-MM-AAAA-Boletim informativo {#nl-yyyy-mm-newsletter}
