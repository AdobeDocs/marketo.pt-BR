---
description: Modelo do programa de webinário. Use-o para webinários com uma convenção de nomenclatura padrão.
...
# WBN-DD-MM-AAAA-Programa de webinário {#wbn-yyyy-mm-dd-webinar-program}
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <td>Campanha inteligente</td>
   <td> </td>
   <td>02c - Enviar Lembrete de Convite Última Chance</td>
  </tr>
  <tr>
   <td>Campanha inteligente</td>
   <td> </td>
