---
description: Saiba mais sobre a sincronização de campo personalizado do membro do programa com o Salesforce. Mantenha os dados do membro personalizado sincronizados com seu CRM.
