...
description: Saiba mais sobre os tokens de campo personalizado dos membros do programa. Use tokens para inserir dados do membro em emails e landing pages.
...
>[!NOTE]
>
>Lembre-se de aprovar seu email.
