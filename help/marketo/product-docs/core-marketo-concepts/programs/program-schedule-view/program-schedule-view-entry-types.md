...
description: Saiba mais sobre os tipos de entrada da Exibição de programação. Entenda programas de email, Campanhas inteligentes e outros tipos de entrada.
title: Tipos de de entrada da visualização Cronograma do programa
...
# Tipos de de entrada da visualização Cronograma do programa {#program-schedule-view-entry-types}
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td colspan="1" rowspan="1">Tipo de entrada padrão. Use como espaço reservado ou observação. </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="1" rowspan="1"><p>Campanha inteligente programada com pelo menos uma etapa do fluxo Enviar email.</p></td>
  </tr>
  <tr>
   ...
   <td colspan="1" rowspan="1">Programa de email programado.</td>
  </tr>
  <tr>
   ...
   <td colspan="1" rowspan="1">Testar emails em um programa de email agendado.</td>
  </tr>
  <tr>
  ...
  <tr>
   <td colspan="1" rowspan="1">Webinário <img alt="--" src="assets/image2014-9-24-10-3a6-3a4.png" data-linked-resource-id="3082721" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147243"></td>
   <td colspan="1" rowspan="1">Data do webinário de um programa de evento conectado a um provedor de webinário compatível.</td>
  </tr>
  <tr>
   ...
   <td colspan="1" rowspan="1">Data do evento principal de um programa de evento não conectado a um provedor de webinário compatível.</td>
  </tr>
 </tbody>
</table>
