...
1. Vá para o **Administrador** e clique em **Entrada de calendário** **Tipos**.
...
## Mostrar um tipo de entrada personalizada {#unhide-a-custom-entry-type}

Se você quiser mostrar um tipo de entrada personalizada, também será fácil.

1. Clique com o botão direito do mouse na entrada e selecione **Mostrar**.
