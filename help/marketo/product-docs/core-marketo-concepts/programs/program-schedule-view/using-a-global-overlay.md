...
description: Saiba como usar uma sobreposição global na Exibição do cronograma do programa. Aplique uma sobreposição entre programas para uma exibição consistente.
