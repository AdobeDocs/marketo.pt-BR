...
description: Saiba como navegar na Exibição de programação do programa. Percorra o tempo e visualize as entradas programadas em seu programa.
...
1. Selecione seu programa. Clique no menu suspenso **[!UICONTROL Exibir]**. Selecione **[!UICONTROL Agendar]**.
   ...
   A exibição do cronograma do seu programa agora é exibida.
