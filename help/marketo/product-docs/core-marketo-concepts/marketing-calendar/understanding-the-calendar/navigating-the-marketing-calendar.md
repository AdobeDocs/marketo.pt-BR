...
description: Saiba como navegar no Calendário de marketing, incluindo modos de 3 semanas e meses. Alternar exibições e usar a agenda para ver os ativos agendados.
...
Saiba como navegar no Calendário de marketing.
...
1. Selecione a exibição **[!UICONTROL Agenda]**.
   ...
   Esta exibição mostra tudo o que foi planejado.
...
Estas são as noções básicas. Você também pode personalizar a visualização usando filtros.
