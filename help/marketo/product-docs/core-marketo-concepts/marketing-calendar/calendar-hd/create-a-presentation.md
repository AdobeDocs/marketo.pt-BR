...
Crie uma apresentação para projetar as visualizações e metas do calendário da sua equipe em uma TV de alta definição. Presentations são específicos do Workspace.
