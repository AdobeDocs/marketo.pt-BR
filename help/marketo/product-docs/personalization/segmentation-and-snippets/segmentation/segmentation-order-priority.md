...
description: Saiba mais sobre a prioridade da ordem de segmentação e como ela determina a qual segmento uma pessoa pertence. Edite a ordem dos segmentos no banco de dados para controlar a avaliação dos segmentos.
