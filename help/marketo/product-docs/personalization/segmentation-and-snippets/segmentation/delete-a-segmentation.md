...
description: Saiba como excluir uma segmentação que não é mais necessária. Remova as associações de ativos, cancele a aprovação da segmentação e use as Ações de segmentação para excluir.
