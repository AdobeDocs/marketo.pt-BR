...
description: Saiba como criar um trecho para conteúdo dinâmico em emails e landing pages. Crie um novo snippet e adicione conteúdo para reutilização entre os ativos.
title: Criar um snippet
