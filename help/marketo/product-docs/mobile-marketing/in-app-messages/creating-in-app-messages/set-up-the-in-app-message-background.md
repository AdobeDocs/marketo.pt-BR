...
description: Configurar o plano de fundo das mensagens no aplicativo - Documentos do Marketo - Documentação do produto
...
>[!TIP]
>
>Para imagens de plano de fundo, texturas e gradientes normalmente funcionam melhor.

1. No editor, clique na área de plano de fundo.

   ![](assets/image2016-5-9-8-3a38-3a1.png)

1. Para definir uma cor, clique em **Cor**, em seguida, o quadrado de seleção de cores. Selecione a cor clicando nela ou inserindo os códigos hexadecimal ou RGB no seletor de cores.
...
1. Se quiser usar um plano de fundo, clique em **Imagem** e depois a **Selecionar imagem** link .
...
1. Avalie os resultados. Oops - talvez uma cor, textura ou gradiente simples funcionem melhor!

   ![](assets/image2016-5-9-9-3a2-3a33.png)

1. Aplique uma borda de imagem opcional. A configuração padrão é **Desligado**. Primeiro, selecione a cor clicando nela ou inserindo os números Hex ou RGB no seletor de cores.

   ![](assets/image2016-5-9-9-3a54-3a8.png)

1. Clique nas setas para variar a largura da borda. Essa borda verde de 12 pixels altera a aparência da mensagem no aplicativo.
