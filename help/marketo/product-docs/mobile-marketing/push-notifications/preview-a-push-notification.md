...
Ou, na página de exibição Notificação por push, clique em **[!UICONTROL Ações de Notificação por Push]** e depois em **[!UICONTROL Visualizar]**. Ou clique em **[!UICONTROL Visualizar]** na extremidade direita.
