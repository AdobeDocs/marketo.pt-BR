...
description: Personalize quando você receber atualizações por email sobre seus esforços de SEO por meio das Preferências de email.
title: SEO - Definir suas preferências de alerta por email
...
# SEO - Definir suas preferências de alerta por email {#seo-set-your-email-alert-preferences}
...
1. Na barra de navegação superior, clique no seu nome de usuário. Clique em **[!UICONTROL Preferências de email]**.
