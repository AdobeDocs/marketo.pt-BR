...
description: Adicione observações a problemas de página como lembretes ou mensagens de equipe da seção Problemas ou do detalhamento de Detalhes da página.
...
Saiba como adicionar notas aos problemas da página como lembretes pessoais ou mensagens de equipe.
