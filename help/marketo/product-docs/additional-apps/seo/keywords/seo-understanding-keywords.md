...
# SEO - Noções básicas [!UICONTROL Palavras-chave] {#seo-understanding-keywords}

[!UICONTROL Palavras-chave] são a espinha dorsal de sua estratégia de SEO. Seu objetivo é estar na primeira página, o mais próximo possível de #1 para palavras-chave relevantes para sua empresa.

A variável [!UICONTROL Palavras-chave] mostrará o sucesso do seu site em atingir esse objetivo e como você faz a pilha de [seus concorrentes](/help/marketo/product-docs/additional-apps/seo/understanding-seo/seo-add-competitors.md).
...
Ótimo! Agora que você entende o [!UICONTROL Palavras-chave] vamos aprender sobre páginas e links de entrada.

>[!MORELIKETHIS]
>
>* [Entender páginas](/help/marketo/product-docs/additional-apps/seo/pages/seo-understanding-pages.md)
