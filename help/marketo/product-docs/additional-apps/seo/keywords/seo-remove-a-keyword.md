...
description: SEO - Remover uma palavra-chave - Documentos do Marketo - Documentação do produto
...
1. Clique em para ir até a seção **Palavras-chave**.

   ![](assets/image2014-9-18-13-3a35-3a52.png)

1. Passe o mouse sobre a palavra-chave que deseja remover e clique em **DELETE**.
...
1. Clique em **Delete** novamente para confirmar.
   ...
   Que alívio! Agora você pode avançar para coisas maiores e melhores.
