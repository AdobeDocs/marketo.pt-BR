...
description: Abra os resultados do mecanismo de pesquisa para uma palavra-chave em uma nova janela para ver como seu conteúdo aparece na pesquisa.
...
Se você quiser ver a aparência do conteúdo em um mecanismo de pesquisa, adicionamos um atalho.
