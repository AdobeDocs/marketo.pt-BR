...
description: Saiba como agendar um teste A/B para um programa de email. Defina a hora de envio e quando o vencedor será declarado.
...
1. Selecione a data **[!UICONTROL Enviar Teste]**.

![](assets/schedule-the-a-b-test-1.png)

1. Selecione a hora **[!UICONTROL Enviar teste]**.
...
1. Repita as etapas 1 e 2 para _Enviar vencedor_. Insira os destinatários da notificação (opcional) e clique em **[!UICONTROL Avançar]**.
...
1. Revise o resumo e clique em **[!UICONTROL Fechar]**.

   ![](assets/schedule-the-a-b-test-4.png)

   Você perceberá que o bloco **[!UICONTROL Agenda]** foi atualizado.
