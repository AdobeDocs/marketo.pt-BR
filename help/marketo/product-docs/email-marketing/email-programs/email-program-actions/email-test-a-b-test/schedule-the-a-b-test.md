...
1. Faça a mesma coisa para **[!UICONTROL Enviar Vencedor]**. Insira os destinatários da notificação (opcional) e clique em **[!UICONTROL Avançar]**.
   ...
   Super! Você concluiu, basta revisar o resumo e clicar em **[!UICONTROL Fechar]**.
