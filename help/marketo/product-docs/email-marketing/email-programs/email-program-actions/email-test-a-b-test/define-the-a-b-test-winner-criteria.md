...
description: Saiba como definir os critérios de vencedor do teste A/B. Defina a métrica e o limite que determinam qual variante ganha o teste.
...
1. As opções padrão de **[!UICONTROL Critério de vencedor]** são listadas primeiro.
   ...
   <td>Uma página aberta é registrada quando imagens são baixadas em um email. Mesmo que você não inclua uma imagem, por padrão, o Marketo insere um único pixel de rastreamento em todos os emails HTML.</td>
   </tr>
   <tr>
