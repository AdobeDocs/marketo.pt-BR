...
description: Use O Teste A/B "Do Endereço" - Documentação Do Marketo - Documentação Do Produto
...
Você pode facilmente testar seus emails A/B. Um teste interessante é o **Do endereço** teste. Veja como configurar isso.
...
1. No **E-mail** bloco, com seu email selecionado, clique em **Adicionar teste A/B**.
...
1. Insira o segundo **Do endereço** informações que deseja testar.
   ...
   >[!TIP]
   >
   >Você pode clicar no link **+** para adicionar quantos Endereços De desejar.
...
1. Use o controle deslizante para escolher qual porcentagem do público-alvo você deseja no teste A/B e clique em **Próxima**.
   ...
   >[!NOTE]
   >
   >As diferentes variações enviarão partes iguais do tamanho escolhido da amostra de teste.
