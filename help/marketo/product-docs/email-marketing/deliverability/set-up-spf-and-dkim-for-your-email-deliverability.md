...
Um método rápido para melhorar as taxas de entrega de email é incorporar o **SPF** (Estrutura de Política de Remetente) e o **DKIM** (Email Identificado de Chaves de Domínio) às configurações de DNS. Com essa adição às entradas de DNS, você informa aos destinatários que autorizou o Marketo a enviar emails em seu nome. Sem essa alteração, seu email tem uma chance maior de ser marcado como spam, pois foi endereçado do seu domínio, mas enviado de um endereço IP com um domínio Marketo.
