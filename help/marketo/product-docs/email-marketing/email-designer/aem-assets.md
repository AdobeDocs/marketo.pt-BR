...
description: Saiba como usar imagens do AEM Assets em emails do Marketo Engage. Vincule o AEM Cloud Services e use o Assets as a Cloud Service no designer.
