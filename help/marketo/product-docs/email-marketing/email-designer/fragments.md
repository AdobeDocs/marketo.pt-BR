...
<tbody>
  ...
  <tr>
    <td><b>Publicado</b></td>
    <td>Ao publicar um fragmento, ele fica disponível para uso em um email ou template de email. Um conteúdo de fragmento publicado não pode ser modificado no designer visual.
    <p>Ações disponíveis:
