...
product: marketo
title: Verificador de marca
description: Saiba como criar, validar e gerenciar conteúdo na marca usando o verificador de pontuação da marca.
...
1. Clique no ícone ![Tela cheia para obter insights detalhados](assets/icon-fullscreen.svg "Tela cheia") para obter uma exibição detalhada da sua pontuação de qualidade.
