...
Abaixo estão os ícones da nova interface Adobe Marketo Engage. Se você precisar fazer referência aos ícones do Marketo Classic, eles poderão ser [encontrados aqui](/help/marketo/getting-started/classic-icon-glossary.md).
