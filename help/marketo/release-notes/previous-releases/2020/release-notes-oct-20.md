...
* **Integração com o Microsoft Dynamics 365**: Automatize a inscrição de leads e contatos em campanhas do Microsoft Dynamics 365. Adicione ou remova facilmente Marketo Engage Leads e Contatos para Campanhas do MS Dynamics com novas ações de fluxo de campanha inteligente. Transmita indubitavelmente leads de Marketing para Vendas e feche negócios mais rapidamente.
...
Assista à gravação de nosso webinário de versão do produto [here](https://engage.marketo.com/Oct_20_Release_OnDemand.html).
