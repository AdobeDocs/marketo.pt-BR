...
<table style="table-layout:auto"> 
 <tbody> 
  ...
  <tr> 
   ...
   <tr> 
   <td><strong>Localização de webinários interativos</strong>: permite exibir os detalhes do Programa de evento do webinário interativo do Marketo no idioma desejado, bem como escolher o idioma de entrega, se desejar, diferente do idioma do usuário do Marketo que criou o Programa de evento.</td> 
   <td>Remetido</td>
...
<table style="border: 0px">
 <tbody> 
  ...
  <tr> 
   ...
   <td>Remetido</td>
   <td><a href="/help/marketo/product-docs/demand-generation/dynamic-chat/automated-chat/stream-designer.md#stream-designer-cards" target="_blank">Cartões de Designer de Stream</a></td>
  </tr>
   <tr> 
   <td> </td> 
   <td> </td>
  ...
  <tr> 
   ...
   <td>Remetido</td>
   <td><a href="/help/marketo/product-docs/demand-generation/dynamic-chat/dynamic-chat-activities.md" target="_blank">Atividades Dynamic Chat</a></td>
  </tr>
   <tr> 
   <td> </td> 
   <td> </td>
