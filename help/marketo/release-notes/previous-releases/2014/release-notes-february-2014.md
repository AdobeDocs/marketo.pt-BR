...
## Guia de resultados do programa de e-mail {#email-program-results-tab}
...
* Link de cliques para links na página da Web
* Link clicado para o link clicado na página da Web
