...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Abrir beta</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/coworker-for-marketo/overview" target="_blank">Visão geral da IA do Marketo</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
