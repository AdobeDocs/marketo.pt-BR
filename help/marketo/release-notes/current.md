...
* **Filtragem** aprimorada: Várias APIs agora oferecem suporte para mais filtragem, como adicionar um filtro de intervalo de datas a ativos de email e campos de membros do programa.
