---
description: Novas Notas De Versão - Documentação Do Marketo - Documentação Do Produto
title: Novas notas de versão
hide: true
hidefromtoc: true
...
* **Atualizar para Google Analytics 4**: os usuários do RTP terão uma tag alfanumérica exclusiva (localizada na dentro da `<head>` do html) nas páginas de aterrissagem que permite que o Marketo envie dados para o Google Analytics. O Marketo utilizava anteriormente o Universal Analytics, que deixará de gravar dados até 1º de julho de 2023. Os usuários do RTP precisarão seguir o processo de migração no painel de Google Analytics para concluí-la.

* **Atualização para jQuery 3.7**: para melhorar a segurança e a estabilidade, o Marketo está atualizando para jQuery 3.7.0. Os usuários do RTP que carregam o jQuery por conta própria podem ser afetados negativamente se estiverem usando uma versão anterior à 3.0.0. Esses usuários podem entrar em contato com o Suporte da Marketo para obter ajuda sobre como implementar uma versão específica do rtp.js de acordo com suas necessidades. Se você estiver usando a versão 3.0.0 ou posterior, você não será afetado.
