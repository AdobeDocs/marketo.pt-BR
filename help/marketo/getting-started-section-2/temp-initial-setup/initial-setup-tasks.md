...
Após esta configuração inicial, reveja nosso [Práticas recomendadas para uma nova instância do Marketo Engage](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) para obter o máximo do seu investimento e preparar-se para o sucesso a longo prazo.
