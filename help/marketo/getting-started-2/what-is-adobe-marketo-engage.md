...
**AJUSTE E POSSIVELMENTE RETITLE**
...
Sim, fizemos um [lista de verificação de coisas a serem feitas](/help/marketo/getting-started/setup/setup-checklist.md){target="_blank"}.
