...
Agora que você concluiu todas as [tarefas de configuração inicial](/help/marketo/getting-started-2/initial-setup/initial-setup-tasks.md), é hora de estabelecer alguns elementos fundamentais para garantir um uso contínuo e sem problemas. Isso estabelecerá a base para sua jornada com o Marketo Engage e ajudará você a aproveitar ao máximo seus recursos. Vamos começar!

>[!NOTE]
>
>Você também pode baixar a lista de verificação [INSERIR LINK] e confira as etapas seguidas.
...
Agora que sua conta Marketo Engage está pronta para ser ativada, consulte nossa [Práticas recomendadas para uma nova instância do Marketo Engage](/help/marketo/getting-started-2/implementing-a-new-marketo-engage-instance/where-to-start.md) para obter o máximo do seu investimento e preparar-se para o sucesso a longo prazo.
