...
+ Documentação do produto {#product-docs}
   ...
   + Sincronização do CRM {#crm-sync}
      ...
      + Sincronização com Salesforce {#salesforce-sync}
         ...
         + Detalhes da Sincronização do SFDC {#sfdc-sync-details}
   ...
   + Marketing por email {#email-marketing}
      ...
      + Geral {#general}
         ...
         + Editor de Novo Email do Beta {#beta-new-email-editor}
            + [Visão geral do novo editor de email (beta)](product-docs/email-marketing/general/beta-new-email-editor/overview.md)
            + [Criação de email](product-docs/email-marketing/general/beta-new-email-editor/email-authoring.md)
            + [Modelos de e-mail](product-docs/email-marketing/general/beta-new-email-editor/email-templates.md)
   ...
   + Conexão de vendas do Marketo {#marketo-sales-connect}
      ...
      + CRM {#crm}
         + Personalização do Salesforce {#salesforce-customization}
            ...
            + [Desinstale o Marketo Sales Connect do Salesforce Classic](product-docs/marketo-sales-connect/crm/salesforce-customization/uninstall-marketo-sales-connect-from-salesforce-classic.md)
         ...
         + Integração com o Salesforce {#salesforce-integration}
