      ...
      + Ações {#actions}
         ...
         + E-mail {#email}
            ...
            + Entrega de email {#email-delivery}
               ...
               + [Configuração de um canal de delivery personalizado](product-docs/marketo-sales-insight/actions/email/email-delivery/setting-up-a-custom-delivery-channel.md)
         + Marketo {#marketo}
